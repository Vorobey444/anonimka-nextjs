...
VALUES
  (random_token(), 'Смайлик', 'Девушка', 'Девушку', 'Путешествия', 25, 35, 27, 'Астана', 'KZ', 'Обычное', 
  ...
  (random_token(), 'Кофейный маньяк', 'Девушка', 'Девушку', 'Дружба', 23, 30, 26, 'Астана', 'KZ', 'Стройное',
...
VALUES
  ...
  (random_token(), 'Сладкоежка', 'Девушка', 'Девушку', 'Дружба', 22, 30, 27, 'Алматы', 'KZ', 'Плотное',
...
VALUES
  ...
  (random_token(), 'Снежинка', 'Девушка', 'Девушку', 'Встречи', 24, 32, 28, 'Костанай', 'KZ', 'Стройное',
   'Ищу компанию для прогулок, фотосессий и спонтанных поездок за город. Без планов — по настроению!', NOW() - INTERVAL '1 day'),
   
  (random_token(), 'Загадка', 'Девушка', 'Девушку', 'Переписка', 22, 30, 25, 'Костанай', 'KZ', 'Обычное',
...
INSERT INTO ads (user_token, nickname, gender, target, goal, age_from, age_to, my_age, city, country, body_type, text, created_at)
VALUES
  (random_token(), 'Бабочка', 'Девушка', 'Девушку', 'Дружба', 20, 28, 24, 'Тараз', 'KZ', 'Стройное',
   'Ищу подругу для кофе, шопинга и обсуждения того, почему мы всегда опаздываем.', NOW() - INTERVAL '6 hours'),
   
  (random_token(), 'Звезда', 'Девушка', 'Девушку', 'Переписка', 25, 33, 29, 'Тараз', 'KZ', 'Обычное',
   'Хочу просто переписываться, делиться мемами и обсуждать сериалы. Без обязательств!', NOW() - INTERVAL '9 hours'),
   
  (random_token(), 'Улыбка', 'Девушка', 'Пару', 'Встречи', 27, 38, 32, 'Тараз', 'KZ', 'Плотное',
