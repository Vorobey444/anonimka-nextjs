...
// Список модулей для импорта в правильном порядке (абсолютные пути)
const modules = [
    '/webapp/modules/telegram-init.js',    // 1. Инициализация Telegram WebApp
    ...
    '/webapp/modules/auth.js',              // 5. Аутентификация
    '/webapp/modules/auth-modals.js',       // 6. Модальные окна авторизации
    '/webapp/modules/location-data.js',     // 7. Данные локаций
    '/webapp/modules/location.js',          // 8. Работа с локациями
    '/webapp/modules/ads.js',               // 9. Объявления
    '/webapp/modules/chats.js',             // 10. Чаты
    '/webapp/modules/world-chat.js',        // 11. Мировой чат
    '/webapp/modules/photos.js',            // 12. Управление фотографиями
    '/webapp/modules/premium.js',           // 13. Премиум функции
    '/webapp/modules/referral.js',          // 14. Рефералка
    '/webapp/modules/onboarding.js',        // 15. Онбординг
    '/webapp/modules/menu.js'               // 16. Навигация
];
